...
/**
 * Converts raw sensor data into MeasuredData object.
 * 
 * @author czogalik
 *
 */
public class RawToPlantowerDataConverter
		extends MultipleInputSingleOutputFilter<MeasuredData<Object>, MeasuredData<PlantowerData>> {
	...
	public RawToPlantowerDataConverter(DataPipe<MeasuredData<Object>> input,
			DataPipe<MeasuredData<PlantowerData>> output) {
	...
	private MeasuredData<PlantowerData> createMeasuredDataStructure(MeasuredData<Object> checksum,
			MeasuredData<Object> sensor1, MeasuredData<Object> sensor2, MeasuredData<Object> sensor3) {
	...
	private Optional<MeasuredData<Object>> getMeasurementWith(String targetId) {
		...
		return getInputData().stream().filter(isMeasurementWith(targetId)).findFirst();
