...
public class RawToPlantowerDataConverter extends MultipleInputSingleOutputFilter<MeasuredData<Object>,MeasuredData<PlantowerData>> {
	...
	public void apply() {
		...
		MeasuredData<PlantowerData> result = createMeasuredDataStructure(sensor1, sensor2, sensor3);
		
		addResultToOutput(result);
		
	}

	private MeasuredData<PlantowerData> createMeasuredDataStructure(MeasuredData<Object> sensor1, MeasuredData<Object> sensor2, MeasuredData<Object> sensor3) {
		...
		return new MeasuredData<PlantowerData>(id, new PlantowerData(s1, s2, s3));
